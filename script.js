document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    function clearError(field) {
      ...
      const existingError = field.parentNode
        ? field.parentNode.querySelector('.form-error-message')
        : null;
      if (existingError) {
    ...
    const validatableFields = contactForm.querySelectorAll(
      'input:not([type="hidden"]):not([type="submit"]):not([type="reset"]):not([type="button"]):not([type="checkbox"]):not([type="radio"]), textarea, select'
    );
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "AMITOS משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '8a689798-5968-4b52-80df-1ce5a380d45d',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '8a689798-5968-4b52-80df-1ce5a380d45d';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '8a689798-5968-4b52-80df-1ce5a380d45d';
